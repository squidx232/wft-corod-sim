...
export const ar: Record<string, string> = {
  ...
  'header.subtitle': 'مدرب ويذرفورد للقضبان المستمرة وعمليات موقع البئر',
  // --- Intro splash ---
  'intro.eyebrow': 'تدريب عمليات موقع البئر',
  'intro.title': 'محاكي مشغّل كورود® موبايل جريبر™',
  'intro.subtitle': 'مدرب ويذرفورد الغامر للقضبان المستمرة وعمليات موقع البئر، بهيدروليك واقعي وأدوات تحكم أصلية وتقييم موقوت للاستجابة للطوارئ.',
  'intro.start': 'ابدأ',
  'header.rev': 'إصدار ٢٥',
